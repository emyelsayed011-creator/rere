...
@Component({
        ...
        <form [formGroup]="form" (ngSubmit)="submit()">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input class="form-control border-start-0 ps-0" type="tel" formControlName="phone" placeholder="+20 1xx xxx xxxx">
            </div>
  ...
  styles: [`
    ...
    .auth-split-card { display: grid; grid-template-columns: 1fr 1fr; border-radius: 1.5rem; max-width: 820px; width: 100%; margin: 2rem auto; }
  ...
  async submit() {
    ...
    try {
      ...
      const msgs = raw
        ...
        : [e?.error?.detail || 'Registration failed.'];
      this.errors.set(msgs as string[]);
