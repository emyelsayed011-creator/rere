...
const EN: Dict = {
  ...
  'form.emailNotConfirmed': 'Please confirm your email before creating a listing. Check your inbox for the verification link.',
  ...
  'auth.phoneInvalid': 'Enter a valid Egyptian number',
  'auth.email': 'Email',
...
const AR: Dict = {
  ...
  'form.emailNotConfirmed': 'يرجى تأكيد بريدك الإلكتروني قبل نشر الإعلان. تحقق من بريدك الوارد.',
  ...
  'auth.phoneInvalid': 'أدخل رقم مصري صحيح',
